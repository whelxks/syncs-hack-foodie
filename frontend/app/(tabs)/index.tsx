...
const fakeItems = [
  ...
  },
  {
    ...
    category: "Furniture",
    condition: "Well Used",
    description: "A comfortable office chair with adjustable height and lumbar support.",
  ...
  },
  {
    ...
    category: "Fashion",
    condition: "Used",
    description: "A stylish and functional messenger bag, perfect for carrying your daily essentials.",
